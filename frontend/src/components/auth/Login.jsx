...
const Login = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        dispatch(setUser(res.data.user));  // ← saves to Redux + localStorage via authSlice
  ...
  // Login.jsx — check query param after redirect
  useEffect(() => {
        ...
        >
          ...
          {/* <div className="flex items-center gap-4 my-5">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label className="text-sm">Job Seeker</Label>
            </div>
            <div className="flex items-center space-x-2">
              <Input
                type="radio"
